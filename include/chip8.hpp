...
#include <cstdint>
#include <iostream>
enum EmulatorState { QUIT, RUNNING, PAUSED };
...
private:
  ...
  std::array<bool, SCREEN_WIDTH * SCREEN_HEIGHT>
      display{}; // emulate original CHIP8 pixels
  std::array<uint16_t, STACK_SIZE>
      stack{}; // subroutine stack (12 levels of nesting)
